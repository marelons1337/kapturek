...
module DbHelpers
  class << self
    def create_client_and_property_with_associations
      property_data = {
      ...
      client_data = {
        ...
        rent_from: Faker::Date.between(from: 2.days.ago, to: Time.zone.today + 1.month),
        rent_to: Faker::Date.between(from: Time.zone.today + 2.months, to: Time.zone.today + 3.months),
