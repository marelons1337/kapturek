...
RSpec.describe "/property/expenses", type: :request do
  ...
  describe "GET /index" do
    it "renders a successful response" do
      Property::Expense.create! valid_attributes
  ...
  describe "GET /show" do
    it "renders a successful response" do
      expense = Property::Expense.create! valid_attributes
  ...
  describe "POST /create" do
    context "with valid parameters" do
      it "creates a new Property::Expense" do
        ...
        }.to change(Property::Expense, :count).by(1)
      end
    ...
    context "with invalid parameters" do
      it "does not create a new Property::Expense" do
        ...
        }.to change(Property::Expense, :count).by(0)
      end
